...
abstract class AbstractTemporalCollectionTest<V extends TemporalValue<Integer>> {
    protected abstract AbstractTemporalCollection<Integer, V> createInstance();
    ...
    public void testTemporalValue_validTemporalRange_and_validValue_shouldReturnBusinessTemporalValue() {
        ...
        AbstractTemporalCollection<Integer, V> collection = createInstance();
